      ...
      <div>
        <div className="page-header">
          ...
          <p style={{ color: "var(--text-dim)", marginTop: 4 }}>
            {selectedGroup.transaction_count} transactions · {formatINR(selectedGroup.total_amount)} · via {SOURCE_LABELS[selectedGroup.source_type] || selectedGroup.source_type}
          </p>
        </div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 12, color: "var(--text-dim)" }}>
                      {bg.totalTxns} transactions · {formatINR(bg.totalAmount)}
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                        <span style={{ fontWeight: 600, fontSize: 14 }}>{formatINR(s.total_amount)}</span>
